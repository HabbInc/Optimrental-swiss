...
export default function AdminVehiclesPage() {
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    const vehicleData = {
      ...
      curb_weight: formData.get("curb_weight")
        ? Number(formData.get("curb_weight"))
        : null,
      max_gross_weight: formData.get("max_gross_weight")
        ? Number(formData.get("max_gross_weight"))
        : null,
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    type="number"
                    step="0.01"
                    defaultValue={editingVehicle?.price_per_hour}
                    required
                    className="h-12 rounded-xl"
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    name="seat_count"
                    type="number"
                    defaultValue={editingVehicle?.seat_count}
                    className="h-12 rounded-xl"
                    placeholder="e.g., 5"
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <select
                    name="euro_class"
                    defaultValue={editingVehicle?.euro_class || ""}
                    className="w-full h-12 rounded-xl border border-input px-3 bg-background"
                  >
                    <option value="">Select...</option>
                ...
                {/* Dimensions Section */}
                <div className="col-span-2 pt-4">
                  <h3 className="uppercase text-xs font-bold tracking-widest text-amber-600 mb-4">
                    Dimensions & Weight
                  </h3>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    type="number"
                    step="0.1"
                    defaultValue={editingVehicle?.width}
                    className="h-12 rounded-xl"
                    placeholder="e.g., 190"
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    type="number"
                    step="0.1"
                    defaultValue={editingVehicle?.length}
                    className="h-12 rounded-xl"
                    placeholder="e.g., 520"
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    type="number"
                    step="0.1"
                    defaultValue={editingVehicle?.height}
                    className="h-12 rounded-xl"
                    placeholder="e.g., 150"
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    name="curb_weight"
                    type="number"
                    defaultValue={editingVehicle?.curb_weight}
                    className="h-12 rounded-xl"
                ...
                <div className="space-y-2 col-span-2">
                  ...
                  <Input
                    ...
                    type="number"
                    defaultValue={editingVehicle?.max_gross_weight}
                    className="h-12 rounded-xl"
                ...
                <div className="col-span-2 grid grid-cols-2 gap-4 bg-slate-50 p-6 rounded-2xl">
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      name="winter_ready"
                      id="winter_ready"
                      defaultChecked={editingVehicle?.winter_ready}
                      className="w-4 h-4 rounded accent-amber-500"
                    />
                    <Label
                      htmlFor="winter_ready"
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      name="winter_tires"
                      id="winter_tires"
                      defaultChecked={editingVehicle?.winter_tires}
                      className="w-4 h-4 rounded accent-amber-500"
                    />
                    <Label
                      htmlFor="winter_tires"
                      className="text-sm cursor-pointer"
                    >
                      Winter Tires
                    </Label>
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      name="studded_tires"
                      id="studded_tires"
                      defaultChecked={editingVehicle?.studded_tires}
                      className="w-4 h-4 rounded accent-amber-500"
                    />
                    <Label
                      htmlFor="studded_tires"
                      className="text-sm cursor-pointer"
                    >
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      type="checkbox"
                      name="child_seat_space"
                      id="child_seat_space"
                      defaultChecked={editingVehicle?.child_seat_space}
                      className="w-4 h-4 rounded accent-amber-500"
                    />
                    <Label
                      htmlFor="child_seat_space"
                      className="text-sm cursor-pointer"
                    >
                      Space for Child Seat
                    </Label>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-2 pt-2 col-span-2">
                  <input
                    ...
                    name="is_available"
                    id="is_available"
                    defaultChecked={editingVehicle?.is_available ?? true}
                    className="w-5 h-5 rounded accent-amber-500"
                  />
                  <Label htmlFor="is_available" className="font-bold">
      ...
      <Card className="rounded-3xl border-none shadow-xl overflow-hidden bg-white">
        <Table>
          <TableHeader className="bg-slate-50">
            <TableRow>
              <TableHead className="uppercase text-[10px] font-bold tracking-widest p-6">
                Vehicle
              </TableHead>
              <TableHead className="uppercase text-[10px] font-bold tracking-widest">
                Pricing
              </TableHead>
              <TableHead className="uppercase text-[10px] font-bold tracking-widest text-center">
                Status
              </TableHead>
              <TableHead className="uppercase text-[10px] font-bold tracking-widest text-right p-6">
                Actions
              </TableHead>
            </TableRow>
          </TableHeader>
                  ...
                  <TableCell className="text-right p-6">
                    <div className="flex justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                      ...
                      <Button
                        variant="outline"
                        size="icon"
                        className="rounded-xl border-slate-200 text-red-500 hover:text-red-600 hover:bg-red-50"
